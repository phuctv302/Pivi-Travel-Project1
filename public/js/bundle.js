...
var showAlert = function showAlert(type, msg, time) {
  hideAlert();
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Login successfully!', 3000);
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', _context.t0.response.data.message, 3);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Error logging out! Please try again.', 3);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Please check your email!', 3);
            }
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', _context3.t0.response.data.message, 3);
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Reset password successfully! Please remember your password.', 4);
              window.setTimeout(function () {
                location.assign('/');
              }, 2000);
            }
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', _context4.t0.response.data.message, 3);
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicGh1Y3R2MzAyIiwiYSI6ImNrdng0NGkwbWNjY2szMHM3Z3NybDU2MG0ifQ.U6z1eZuY-ceOz7A6FcLQ6g';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      closeOnClick: false,
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("Day ".concat(loc.day, ": ").concat(loc.description)).addTo(map); // Extend map bound to include current location
...
var addReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(review, rating, tourId, tourSlug) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Thanks for your reviewing!', 3);
              window.setTimeout(function () {
...
var stripe = Stripe('pk_test_51JwyYkJ8FJNSI7ayLW0i2AeN1MCFPWcbnAmGrlYD4pXcAxNQhCv8cMoipLit6h6WWV4k9yImZmq9NyPqSEONLSXa00VUPxOQ2B');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', _context.t0, 3);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Update ".concat(type.toUpperCase(), " successfully!"), 3000);
              window.setTimeout(function () {
...
var addReviewForm = document.querySelector('.form--review'); // DELEGATION

if (mapBox) {
  (0, _mapbox.displayMap)(JSON.parse(mapBox.dataset.locations));
}
...
if (alertMessage) {
  (0, _alert.showAlert)('success', alertMessage, 12);
}
