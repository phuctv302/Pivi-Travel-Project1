      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Reset password successfully! Please remember your password.');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Thanks for your reviewing!');
              window.setTimeout(function () {
                return location.assign("/tour/".concat(tourSlug));
              }, 1500);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Update ".concat(type.toUpperCase(), " successfully!"));
              window.setTimeout(function () {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              password = document.getElementById('password').value;
              passwordConfirm = document.getElementById('password-confirm').value;
              (0, _auth.resetPassword)(password, passwordConfirm, token);
